...
const buffer = createReport({
  ...
  // this script demonstrates the use of the postProcessor option to remove an unwanted "DRAFT" watermark
  // from the file src/__tests__/fixtures/watermark-present.docx
